...
freq<-makeCalls(pnmSet,cutoff=call.cutoff, group=quote(treatment), method="absolute")
...
caption<-paste("HxB2 positions of the", nrow(hotspots), "hotspot regions with frequency above",hotspot.cutoff,"percent.")
