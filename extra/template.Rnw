...
pepStat:::.plot.aggregate(pnmSet,freq,anno.list,minimalist=minimalist,colorTrack,colorAnno,sizeTrack,sizeAnno,hotspots)
@
...
pepStat:::.plot.clade(pnSet.clade,freq.clade,anno.list,minimalist=TRUE,colorTrack,colorAnno,sizeTrack,sizeAnno,hotspots)
@
